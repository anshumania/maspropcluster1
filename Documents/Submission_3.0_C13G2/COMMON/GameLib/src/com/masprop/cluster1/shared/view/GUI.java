...
public class GUI extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		buttonGameIsDone1
				.setIcon(new javax.swing.ImageIcon(
						getClass()
								.getResource(
										"/com/masprop/cluster1/shared/view/graphics/menu_exit.png"))); // NOI18N
		...
		buttonGameIsDone1.setBorder(new javax.swing.border.SoftBevelBorder(
		...
		wizzardDoneButton
				.setIcon(new javax.swing.ImageIcon(
						getClass()
								.getResource(
										"/com/masprop/cluster1/shared/view/graphics/button_ok.png"))); // NOI18N
		wizzardDoneButton.setText("Done");
		wizzardDoneButton.setToolTipText("Click if you are done.");
		wizzardDoneButton.setBorder(new javax.swing.border.SoftBevelBorder(
				javax.swing.border.BevelBorder.RAISED));
		wizzardDoneButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		wizardDismissButton.setBorder(new javax.swing.border.SoftBevelBorder(
				javax.swing.border.BevelBorder.RAISED));
		wizardDismissButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		javax.swing.GroupLayout wizardWindowLayout = new javax.swing.GroupLayout(
				wizardWindow.getContentPane());
		wizardWindow.getContentPane().setLayout(wizardWindowLayout);
		wizardWindowLayout
				.setHorizontalGroup(wizardWindowLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								...
								Short.MAX_VALUE));
		wizardWindowLayout
				.setVerticalGroup(wizardWindowLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								wizardWindowLayout
		...
		jSplitPane1.setBorder(new javax.swing.border.LineBorder(
		...
		sidebar.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 25,
				25));
		...
		buttonGameIsDone
				.setIcon(new javax.swing.ImageIcon(
						getClass()
								.getResource(
										"/com/masprop/cluster1/shared/view/graphics/button_done.png"))); // NOI18N
		buttonGameIsDone.setText("Done");
		buttonGameIsDone.setToolTipText("Click if you are done.");
		buttonGameIsDone.setBorder(new javax.swing.border.SoftBevelBorder(
				javax.swing.border.BevelBorder.RAISED));
		...
		newGameMenuItem
				.setIcon(new javax.swing.ImageIcon(
						getClass()
								.getResource(
										"/com/masprop/cluster1/shared/view/graphics/menu_new_game.png"))); // NOI18N
		...
		loadGameMenuItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(
		...
		loadGameMenuItem
				.setIcon(new javax.swing.ImageIcon(
						getClass()
								.getResource(
										"/com/masprop/cluster1/shared/view/graphics/menu_load_game.png"))); // NOI18N
		...
		saveGameMenuItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(
		...
		saveGameMenuItem
				.setIcon(new javax.swing.ImageIcon(
						getClass()
								.getResource(
										"/com/masprop/cluster1/shared/view/graphics/menu_save_game.png"))); // NOI18N
		...
		scoresMenuItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(
		...
		scoresMenuItem
				.setIcon(new javax.swing.ImageIcon(
						getClass()
								.getResource(
										"/com/masprop/cluster1/shared/view/graphics/menu_scores.png"))); // NOI18N
		...
		manualMenuItem
				.setIcon(new javax.swing.ImageIcon(
						getClass()
								.getResource(
										"/com/masprop/cluster1/shared/view/graphics/menu_manual.png"))); // NOI18N
		...
		aboutMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/com/masprop/cluster1/shared/view/graphics/menu_about.png"))); // NOI18N
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				...
				jSplitPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 695,
				javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(statusBar,
	...
	private void wizardDismissButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_wizardDismissButtonActionPerformed
		// TODO add your handling code here:
	...
	/* Getters and Setters */
	/**
	 * About menu item. Story: User wants to read something about the
	 * application.
	 * 
	...
	/**
	 * Exit menu item. Story: User wishes to exit the application.
	 * 
	...
	/**
	 * File menu Story: User wishes to perform one of the initial use-cases.
	 * 
	...
	/**
	 * Help menu Story: User wishes to know more about the application or wants
	...
	/**
	 * Load game menu item Story: User wishes to load a game from the disk.
	 * 
	...
	/**
	 * Manual menu item Story: User wishes to read the manual.
	 * 
	...
	/**
	 * Main menu bar. Story: User wishes to perform application control actions.
	 * 
	...
	/**
	 * New game menu item Story: User wishes to start a new game.
	 * 
	 * @return
	 */
	...
	/**
	 * Scores menu item Story: User wishes to browse the score list.
	 * 
