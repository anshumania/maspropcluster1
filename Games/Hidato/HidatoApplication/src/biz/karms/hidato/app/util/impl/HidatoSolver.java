...
public class HidatoSolver implements GameSolver {
     ...
     */
    private Map<Integer, Direction> lastDir = new HashMap<Integer, Direction>();
    /**
    ...
    public Game solveGame(Game game) {
        ...
        this.currentCoo = new Coordinates(predefined.get(currentVal).getX(), predefined.get(currentVal).getY());
            ...
            if (predefined.containsKey(currentVal)) {
                ...
                if (currentCoo.isConsecutive(predefined.get(currentVal))) {
                    ...
                    if (predefined.containsKey(currentVal-1)) {
                        throw new IllegalArgumentException("given matrix is not valid");
                    } else {
                ...
                if (nextDir != null) {
                    ...
                    path.put(currentVal, new Coordinates(currentCoo.getX(), currentCoo.getY()));
                } else {
                    //how deep we must go to be able to remove some value (check if vales are predefined)
                    int i = 0;
    ...
    public Direction nextDir(Direction lastDir) {
        ...
        if (lastDir == null) {
            ...
            if (currentCoo.getY()>0 && matrix.getCell(temp).getCurrentValue()==0) {
        ...
        if (lastDir != null) {
            if (lastDir.equals(Direction.BOTTOM)) {
                temp = new Coordinates(currentCoo.getX()-1, currentCoo.getY()-1);
                if (currentCoo.getX()>0 && currentCoo.getY()>0 && matrix.getCell(temp).getCurrentValue()==0) {
            ...
            if (lastDir.equals(Direction.LEFTBOTTOM)) {
                temp = new Coordinates(currentCoo.getX()-1, currentCoo.getY());
                if (currentCoo.getX()>0 && matrix.getCell(temp).getCurrentValue()==0) {
            ...
            if (lastDir.equals(Direction.LEFT)) {
                temp = new Coordinates(currentCoo.getX()-1, currentCoo.getY()+1);
                if (currentCoo.getX()>0 && currentCoo.getY()<height && matrix.getCell(temp).getCurrentValue()==0) {
            ...
            if (lastDir.equals(Direction.LEFTTOP)) {
                temp = new Coordinates(currentCoo.getX(), currentCoo.getY()+1);
                if (currentCoo.getY()<height && matrix.getCell(temp).getCurrentValue()==0) {
            ...
            if (lastDir.equals(Direction.TOP)) {
                temp = new Coordinates(currentCoo.getX()+1, currentCoo.getY()+1);
                if (currentCoo.getX()<width && currentCoo.getY()<height && matrix.getCell(temp).getCurrentValue()==0) {
            ...
            if (lastDir.equals(Direction.RIGHTTOP)) {
                temp = new Coordinates(currentCoo.getX()+1, currentCoo.getY());
                if (currentCoo.getX()<width && matrix.getCell(temp).getCurrentValue()==0) {
            ...
            if (lastDir.equals(Direction.RIGHT)) {
                temp = new Coordinates(currentCoo.getX()+1, currentCoo.getY()-1);
                if (currentCoo.getX()<width && currentCoo.getY()>0 && matrix.getCell(temp).getCurrentValue()==0) {
