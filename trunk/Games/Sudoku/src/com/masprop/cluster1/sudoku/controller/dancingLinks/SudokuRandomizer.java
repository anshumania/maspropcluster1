 ...
 * of any NxN sudoku
 * The extension point is the SudokuAlgorithm. Therefore different Alogrithms which solve
 * a Sudoku can use this for totally random Sudoku generations.
 * 
...
public class SudokuRandomizer extends Observable{
    ...
    /**
     * Initializes the state of the SudokuRandomizer
     */
     ...
     private int getZoneNumber(int row, int column) {
      ...
      /**
       * Finds the number of Givens in the current state of the partially created sudoku
       */
